            ...
            <div id={teaserStyle.big}>
                ...
                <div id={teaserStyle.teaser}>
                    <div>
                        ...
                        <p className={teaserStyle.header}>
                        I'm an IAAP-certified Web Accessibility Specialist and Technology Director at <a href="https://beaccessible.com" rel="noopener noreferrer" className={teaserStyle.link}>Be Accessible</a>. For our clients, I identify accessibility challenges and potential legal risks in the design of their website, and provide recommended fixes. I've handled development for WordPress, Shopify, and even custom React applications. 
                        </p>
                    </div>
                    <br></br> 
                    <div>
                        ...
                        <p className={teaserStyle.header}>
                        I serve as a Teaching Assistant for the Cyber Security program at <a href="https://bootcamp.uclaextension.edu/" rel="noopener noreferrer" className={teaserStyle.link}>UCLA Extension</a>. I run free workshops, training developers how to build applications that support the broadest circle of people, particularly those that rely on assistive technology.
                        </p>
                    </div>
